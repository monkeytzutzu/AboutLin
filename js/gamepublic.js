...
function shareToWeixin(){
    WeixinApi.ready(function(Api) {
                    ...
                    // 微信分享的数据
                    var desc = '智商超过130的人才能看清它的全貌！！！！';
                    var bestPoint = window.sessionStorage.getItem('stickManPoint');
                    if(!bestPoint||bestPoint==0){
                    desc ='智商超过130的人才能看清它的全貌！！！！';
                    } else {
                    if(bestPoint>=20){
                    desc ='我居然在“看清它的全貌”中获得了'+bestPoint+'分！！原来它是荣耀畅玩4X!!!';
                    }else if(bestPoint<20){
                    desc ='我居然在“看清它的全貌”中才得了'+bestPoint+'分！！完全不知道它是什么东西!!!';
                    }
                    }
                    var wxData = {
                    "appId": "", // 服务号可以填写appId
                    "imgUrl" : 'http://ww1.sinaimg.cn/mw690/9ddb3e4cgw1enzldl058fj203c03cdfw.jpg',
                    "link" : 'http://act.thindo.com/rongyao/paolu/index.html',
                    "desc" : desc,
                    "title" : desc
                    };
